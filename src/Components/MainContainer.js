        ...
        return (
            ...
            <div className=" align-middle p-4 m-4 flex flex-row justify-between">
                <div className="w-1/2 mx-auto px-5 py-10 align-content: center top-40 bg-gray-100">
                   <h1 className="text-sm font-sans m-2 sm:text-4xl md:text-md">Work from Ladakh</h1> 
                   <p className="text-sm m-2 font-sans sm:text-xl md:text-md">India's first digital tourisum eco system </p>
